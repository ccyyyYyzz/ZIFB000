...
public class R581MatchedRun {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // This audited source is therefore the immutable control entry point; the
    // physical entry point is compiled from an independently frozen source.
    String mode="control";
    if(mode.equals("control")) {
      run(
        "matched_control",
        "E:\\zifb_final_9129_luck\\battery_comsol\\02_outputs_core\\R581_CANONICAL_CLOSURE_REBUILD\\inputs\\R581_control_input_COPY.mph",
        "E:\\zifb_final_9129_luck\\battery_comsol\\02_outputs_core\\R581_CANONICAL_CLOSURE_REBUILD\\outputs\\R581_matched_control_SOLVED.mph",
        "dsetR581Ctrl",
        false
      );
    } else if(mode.equals("physical_dense")) {
      run(
        "matched_physical_dense",
        "E:\\zifb_final_9129_luck\\battery_comsol\\02_outputs_core\\R581_CANONICAL_CLOSURE_REBUILD\\inputs\\R581_physical_dense_input_COPY.mph",
        "E:\\zifb_final_9129_luck\\battery_comsol\\02_outputs_core\\R581_CANONICAL_CLOSURE_REBUILD\\outputs\\R581_matched_physical_dense_SOLVED.mph",
        "dsetR581Phys",
        true
      );
    } else {
