// R581 true-mesh matched-control solve. Run only after the mesh-only probe passes.
...
public class R581TrueMeshControlRun {
  static final String INPUT_MPH = "E:\\zifb_final_9129_luck\\battery_comsol\\02_outputs_core\\R581_CANONICAL_CLOSURE_REBUILD\\inputs\\R581_true_mesh_control_input_COPY.mph";
  static final String OUTPUT_MPH = "E:\\zifb_final_9129_luck\\battery_comsol\\02_outputs_core\\R581_CANONICAL_CLOSURE_REBUILD\\outputs\\R581_true_mesh_control_SOLVED.mph";
  static final String CASE_ID = "matched_control_true_mesh";
  static final String DATASET_TAG = "dsetR581CtrlMesh";
  ...
  public static void main(String[] args) throws Exception {
    ...
    Model model = ModelUtil.load("r581_true_mesh_control", INPUT_MPH);
    ...
    String cov = clean(c1(variable, "get", "cov_theta_surf"));
    String theta = clean(c1(variable, "get", "theta_eff_R520"));
    System.out.println("CLOSURE_BEFORE,cov_theta_surf," + cov);
    System.out.println("CLOSURE_BEFORE,theta_eff_R520," + theta);
    require(cov.equals(PRODUCTION_COV), "Unexpected production coverage expression");
    require(theta.equals(PRODUCTION_THETA), "Unexpected production theta expression");
    ...
    ModelUtil.remove("r581_true_mesh_control");
  }
}
