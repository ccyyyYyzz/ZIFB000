...
def read_and_derive():
    ...
    vq_out["derivative_landmarks_used_to_set_Q_s_or_Q_f_cal"] = False
    vq_out["Q_f_cal_from_voltage_calibrated_branch"] = True
    vq_out["shared_trace_used_in_reduced_observation_fit"] = True
    ...
    timing_out["derivative_landmarks_used_to_set_Q_s_or_Q_f_cal"] = False
    timing_out["Q_f_cal_from_voltage_calibrated_branch"] = True
    timing_out["shared_trace_used_in_reduced_observation_fit"] = True
...
def write_build_record(width_mm: float, height_mm: float, audit: dict) -> None:
    ...
    record = {
        ...
        "interpretation_boundary": (
            "full-cell derivative landmarks did not set Q_s or Q_f_cal; Q_f_cal belongs to a "
            "voltage-calibrated branch and the shared trace is used separately in the reduced "
            "observation-layer fit, so the overlay is not independent validation"
        ),
        "metadata_correction": (
