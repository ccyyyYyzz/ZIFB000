...
- **b, hero observation:** registered cycle-20 full-cell voltage and its registered derivative
  ...
  the cubic Savitzky-Golay smooth; amber is `dV/dQ`. The derivative landmarks did not set the
  vertical model markers. `Q_f,cal` belongs to a voltage-calibrated branch, and the same trace is
  used separately in the reduced observation-layer fit; the overlay is not independent validation.
...
positive electrode. The derivative landmarks did not set the model coordinates, but
`Q_f,cal` is a readout from the voltage-calibrated branch and the shared trace is used in its
separate observation-layer fit. The overlay is therefore not independent validation. No panel
infers deposit morphology.
...
| `R582_Fig1b_selected_vq_dvdq.csv` | `D7901F2CDCB35A79AF26719D0665AD42ECBFDCA052023B2230B558B8A9A1066D` |
| `R582_Fig1c_rate_ladder.csv` | `5F5888BBB7BAF770CAEA86446D1AE5FA4D4ED6AF0538194AE88A0D097B6CAF2E` |
| `R582_Fig1d_feature_timing.csv` | `3221CBC4D5C5F03FF4DCA277B068A57FBBB4C68F7BA0A5885AD7AC377F76902A` |
| `R582_Fig1_input_manifest.csv` | `5316172F02007DD5FC622E9BD474A381C13DE21175F839D536D435FD63E85676` |
| `R582_Fig1_build.json` | `6F7D6562CAFF77F9FF1FF0007A23F1668A0C0721476FAC640726A4FF6ED5A82C` |
...
distinction, and the statement that the derivative landmarks did not set the model markers while
`Q_f,cal` remains a voltage-calibrated readout from a branch that uses the shared full-cell trace.
