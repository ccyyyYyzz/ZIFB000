...
- Core claim: among the selected actionable variables displayed in Figure 6,
  current density and oxidized-carrier diffusivity provide large, resolved
  leverage on the positive-electrode averaged saturation point. Their displayed
  shifts exceed those of solved flow rate and the linked felt-geometry branch.
